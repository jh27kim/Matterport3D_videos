...
class HabitatSim(Simulator):
    ...
    def __init__(self, config: Config) -> None:
        ...
        # Jaihoon sim_config has no attribute scene
    ...
    def create_sim_config(
        ...
        for sensor in _sensor_suite.sensors.values():
            ...
            # Jaihoon sim_sensor_cfg has no attribute parameters
            # sim_sensor_cfg.parameters["hfov"] = str(sensor.config.HFOV)
            # sim_sensor_cfg.parameters = dict()
            # sim_sensor_cfg.parameters["hfov"] = str(sensor.config.HFOV)

            sim_sensor_cfg.position = sensor.config.POSITION
            # TODO(maksymets): Add configure method to Sensor API to avoid
            # accessing child attributes through parent interface
            print("Sensor type: ", sensor.sim_sensor_type)
