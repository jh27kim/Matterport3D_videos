...
class ArgumentParser:
    ...
    def add_data_parameters(self):
        ...
        dataset_params.add_argument(
            "--config",
            type=str,
            default="/home/jh27kim/code/current_projects/dataset/matterport/habitat-lab/configs/tasks/pointnav_mp3d.yaml",
        )
        dataset_params.add_argument(
...
#             args = self.parser.parse_args()
            args = self.parser.parse_args([]) # modified for notebook
        else:
